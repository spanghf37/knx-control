...
var ets = require("ets.json"); // JSON export from ETS CSV export

var etsexport = JSON.parse(ets.dataa);
 //alert(etsexport[0].knx_ga_groupname);
 //alert(etsexport[0].knx_ga_address);
 //alert(etsexport[0].knx_ga_central);
 //alert(etsexport[0].knx_ga_unfiltered);
 //alert(etsexport[0].knx_ga_description);
 //alert(etsexport[0].knx_ga_datapointtype);
 //alert(etsexport[0].knx_ga_security);
 //alert(etsexport[0].knx_ga_id);
 //alert(etsexport[0].knx_ga_value);
 //alert(etsexport[0].knx_ga_dptsubtypeunit);
 //alert(etsexport[0].knx_ga_timestamp);
 //alert(etsexport[0].knx_ga_src);

//console.log("**** etsexport parse " + etsexport[0].knx_ga_groupname)
