...
var getinputemoncms = {
	url: "http://" + process.env.EMONCMS_HOST + "/emoncms/feed/timevalue.json?id=" + process.env.EMONCMS_CHECKFEEDID + "&apikey=" + process.env.EMONCMS_APIKEY,
	method: "GET",
	encoding: "utf8",
	headers: headers
};
...
request(getinputemoncms, function(error, response, body) {
	if (!error && response.statusCode === 200) {
		...
		console.log(getinputemoncms.url);
		process.exit(1);
	}
});
